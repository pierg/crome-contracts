...
RUN conda-pack -n crome-contracts -o /tmp/env.tar && \
...
COPY . /home/crome-contracts
RUN git clone https://github.com/pierg/crome-logic.git --branch main --single-branch

WORKDIR /home/crome-contracts

# Copy /venv from the previous stage:
COPY --from=build /venv ./venv

ENV PYTHONPATH "/home/crome-contracts:/home/crome-logic"
